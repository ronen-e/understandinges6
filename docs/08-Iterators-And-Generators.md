...
!> לא ניתן ליצור פונקציה חץ שהיא גם גנרטור
...
!> כל האיטרטורים שנוצרים על ידי גנרטור הם איטרביליים, מפני שגנרטורים מגדירים את התכונה
`Symbol.iterator`
כברירת מחדל.
...
התוצאה היא כזו שהיינו מצפים לה כאשר עובדים עם תווים: הלולאה מדפיסה בהצלחה את התו מסוג זוג חלופי, כמו את יתר התווים.
