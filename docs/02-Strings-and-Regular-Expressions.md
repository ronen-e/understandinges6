...
!> במידה ותכתבו קוד אשר אמור לעבוד במנועי ריצה ישנים של ג׳אווהסקריפט, תמיד השתמשו בקונסטרקטור
`RegExp`
...
מחרוזות בג׳אווהסקריפט תמיד השתרכו מאחורי יכולות קיימות של מחרוזות בשפות אחרות.
לשם הדגמה,
...
הסימון הדביק שומר את סמן האינדקס של התו שמופיע במחרוזת לאחר ההתאמה האחרונה בתוך התכונה
`lastIndex`
...
!> טמפלייט ליטראלס יכולים לגשת לכל משתנה שקיים בסביבה בה הוא מוגדר.
