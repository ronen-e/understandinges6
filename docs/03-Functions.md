...
?> חובה להיזהר בעת שימוש בפונקציות למתן ערכים דיפולטיביים.
...
!> פרמטרים של פונקציה מקבלים סביבה ואזור מת זמנית בנפרד מזה של גוף הפונקציה. משמעות הדבר היא שערך דיפולטיבי של פרמטר אינו יכול לגשת למשתנים אשר מוגדרים בתוך גוף הפונקציה.
...
!> פרמטרים מסוג רסט אינם משפיעים על תכונת
`length`
...
!> יש לשים לב לכך שלא לכל הפונקציות יש פונקציה פנימית
<span dir="ltr">`[[Construct]]`</span>,
