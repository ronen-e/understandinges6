...
?>  תיזרק שגיאה במידה וצידו הימני של ביטוי השמה על ידי פירוק
(
החלק שלאחר סימן
`=`)
מקבל את הערכים
...
?> בדומה לפירוק אוביקטים, חובה להשתמש במאתחל ערך כאשר מפרקים מערך, על ידי שימוש במזהה מסוג
`var`, `let`,
או
`const`.
...
?> בדומה לפעולת השמה על ידי פירוק באוביקט, גם כאן תיזרק שגיאה במידה וצידה הימני של פעולת ההשמה מכיל את הערכים
`null`
או
`undefined`.
...
?> פריטים מסוג רסט חייבים להיות הפריט האחרון בפעולת הפירוק ואסור שיבוא פסיק לאחר מכן. שימוש בפסיק לאחר הגדרת פריטים מסוג רסט נחשב לשגיאה תחבירית
