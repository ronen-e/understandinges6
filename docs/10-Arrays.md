...
בעוד שמערכים רגילים יכולין לגדול ולהתכווץ בזמן שעובדים איתם, מערכים בינאריים תמיד נשארים באותו גודל. לא ניתן להגדיר ערך לאינדקס נומרי שאינו קיים במערך בינארי כמו שאפשר במערכים רגילים, מכיוון ומערכים בינאריים מתעלמים מפעולה כזו.
לדוגמה:
...
בעוד שמערכים בינאריים משתמשים בהרבה מתודות כמו של מערכים רגילים, עדיין חסרות להם מספר מתודות של מערך. המתודות הבאות אינן זמינות על מערכים בינאריים:
...
מקבלת מערך
(רגיל או בינארי)
וארגומנט הזחה פוטנציאלי שממנו יש להכניס את הנתונים. אם לא נעביר דבר נקודת ההתחלה תהיה באינדקס 0. הנתונים מתוך המערך שהועבר כארגומנט מועתקים למערך הבינארי שהוא המטרה ודואג שרק סוגי נתונים תקינים יועתקו.
דוגמה:
...
(
  אינדקס הסיום הוא לא אינדקס מכליל, ממש כמו במתודה
<span dir="ltr">`slice()`()</span>.
)
...
אקמהסקריפט 6 ממשיך את העבודה שנעשתה באקמהסקריפט 5 על ידי הפיכת מערכים לשימושיים יותר. ישנן עוד שתי צורות ליצור מערכים:
אלו הן המתודות
<span dir="ltr">`Array.of()`</span>
ו-
<span dir="ltr">`Array.from()`</span>.
