...
`<canvas>`.
מערכים בינאריים נוצרו כחלק מאותה הרחבה על מנת לבצע חישובים אריתמטיים מהירים ברמת הביטים בג׳אווהסקריפט.

פעולות אריתמטיות בערכים נומריים בג׳אווהסקריפט היו איטיים מדי עבור

מכיוון שהמספרים נשמרו בפורמט נקודה צפה בת 64 ביטים ואז הומרו למספרים שלמים בני 32 ביט בעת הצורך. מערכים בינאריים נוצרו כדי לעקוף מגבלה זו וכדי לספק ביצועים טובים יותר עבור אופרציות אריתמטיות. הרעיון הכללי הוא שניתן להתייחס לכל מספר כאל מערך של ביטים ובצורה זו להשתמש במתודות המוכרות שזמינות לשימוש על מערכים בג׳אווהסקריפט.
