...
!> דריסת מתודה שהוגדרה באמצעות סמל ידוע הופכת אוביקט רגיל לאוביקט אקזוטי, מכיוון שהדבר גורם לשינוי בהתנהגות פנימית. אין לכך השפעה מעשית על הקוד, זה פשוט משנה את הצורה שבה השפה מתייחסת לאוביקט.
...
!> מצב דיפולטיבי משמש אותנו רק עבור האופרטורים
`==`, `+`,
