...
אחד ההבטים המעניינים , ולעיתים מבלבלים, של  JavaScript כאשק קוראים למאפיינים שלא קיימים הוא לא זוקר שגיאה. במקום, הערך `undefined` הוא ממומש בשביל המאפיין, כמו בדוגמה:
