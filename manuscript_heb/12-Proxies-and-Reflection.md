...
*ידמה*
(*virtualizes*)
את המטרה בצורה כזו שהן הפרוקסי והן אובייקט המטרה נחשבים לאותו אובייקט לקוד שפועל עליהם.

אובייקטים מסוג פרוקסי מאפשרים לנו ליירט פעולות בסיסיות על אובייקט המטרה, שבמצב רגיל מנוהלות רק ע"י מנוע הג'אווה סקריפט. פעולות בסיסיות אלו מיורטות באמצעות
*מלכודת*
...
ממשק ההתבוננות
היחסים בין פרוקסי לבין ממשק ההתבוננות
